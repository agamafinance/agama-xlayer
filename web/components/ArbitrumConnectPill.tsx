...
// Same look as the Stellar / Rayls connect pills: dark-green AnimatedButton with the
// slide-up hover effect, address shortened and centred in a "Connect Wallet" footprint.
const pillProps = {
...
export function ArbitrumConnectPill() {
