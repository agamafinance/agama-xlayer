...
// Same look as the Stellar / Sui / Arbitrum connect pills: dark-green AnimatedButton
// with the slide-up hover, address shortened and centred in a "Connect Wallet" footprint.
const pillProps = {
...
export function StarknetConnectPill() {
  const { address, connect, disconnect } = useStarknetWallet();
