...
import { amountStr, blendedAprPct, projectNav, sharePriceStr, type Snapshot } from '@/lib/magicblock/agama';
...
export default function NavChart({ vault, now, live }: { vault: Snapshot | null; now: number; live: number[] }) {
  ...
  return (
    <div className="rounded-2xl bg-[#fdfaf1] p-6 shadow-[0_1px_3px_rgba(20,50,35,0.06),0_10px_30px_rgba(20,50,35,0.09)]">
      ...
      <svg className="mt-4 w-full" viewBox={`0 0 ${W} ${H}`} preserveAspectRatio="xMidYMid meet">
        <defs>
          <linearGradient id="mbnavfill" x1="0" y1="0" x2="0" y2="1">
        ...
        <path d={area} fill="url(#mbnavfill)" />
