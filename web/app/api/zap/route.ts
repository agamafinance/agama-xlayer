...
import {STOCKS} from "@/lib/xlayer/config";
import {deployments} from "@/lib/xlayer/generated/deployments";

export const dynamic = "force-dynamic";

const HOST = "https://web3.okx.com";
const XLAYER_ID = 196; // the aggregator only has routes on mainnet
