...
# Needs anvil running: anvil --fork-url https://rpc.xlayer.tech --chain-id 1961
set -euo pipefail
cd "$(dirname "$0")/.."
RPC=${RPC_URL:-http://127.0.0.1:8545}
cast rpc anvil_reset '{"forking":{"jsonRpcUrl":"https://rpc.xlayer.tech"}}' --rpc-url "$RPC" >/dev/null
